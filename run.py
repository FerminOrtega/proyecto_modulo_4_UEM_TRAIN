...
def root():
    ...
    return {"Proyecto": "Mod. 4 - Ciclo de vida de modelos IA - Fermin Ortega Dominguez"}
...
def train_model_route():
    ...
    metrics_dict = train_model.training_pipeline(df_path)

    # Se puede devolver lo que queramos (mensaje de éxito en el entrenamiento, métricas, etc.)
    return {
        "TRAINING MODEL": "Mod. 4 - Ciclo de vida de modelos IA - Fermin Ortega Dominguez",
        "STATUS": "Modelo entrenado y guardado correctamente",
