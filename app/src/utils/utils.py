...
class IBMCOS:
    ...
    def save_object_in_cos(self, obj, name, timestamp, bucket_name='models-fod-uem'):
        """
        ...
        try:
            ...
            print("CLIENT ERROR COS: {0}\n".format(be))
        except Exception as e:
            print("Unable to create object: {0}".format(e))

    def get_object_in_cos(self, key, bucket_name='models-fod-uem'):
        """
